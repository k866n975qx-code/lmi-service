...
class Settings(BaseSettings):
    ...
    lm_investment_account_ids: str | None = Field(default=None, alias="LM_INVESTMENT_ACCOUNT_IDS")
    lm_margin_account_ids: str | None = Field(default=None, alias="LM_MARGIN_ACCOUNT_IDS")
    lm_primary_investment_account_id: str | None = Field(default=None, alias="LM_PRIMARY_INVESTMENT_ACCOUNT_ID")
    ...
    goal_target_ltv_pct: float = Field(default=35.0, alias="GOAL_TARGET_LTV_PCT")
